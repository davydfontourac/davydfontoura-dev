export const projects = [
  {
    ...
    description:
      "Desenvolvimento do site institucional da empresa TREIS – Soluções em Tecnologia, com foco em apresentar serviços, reforçar a identidade visual e garantir navegação responsiva.",
    ...
    seo: {
      ...
      description:
        "Desenvolvimento do site institucional da TREIS Tecnologia com design responsivo e moderno. Projeto realizado por Davyd Fontoura usando HTML5, Tailwind CSS e JavaScript.",
      keywords:
        "treis tecnologia, site institucional, desenvolvimento web, html5, tailwind css, javascript, davyd fontoura, front-end developer",
  ...
  },
  {
    ...
    slug: "klin-ecommerce",
    description:
      "Atuei no desenvolvimento do sistema B2B da marca Klin, com foco em experiência do usuário e responsividade. Trabalhei na implementação de interfaces e adaptação de componentes para diferentes dispositivos. O projeto foi realizado em parceria com a empresa TREIS – Soluções em Tecnologia.",
    ...
    seo: {
      title:
        "Sistema B2B Klin - E-commerce Infantil - Davyd Fontoura | Portfolio",
      description:
        "Desenvolvimento de sistema B2B para a marca Klin, especializada em calçados infantis. Interface responsiva e otimizada desenvolvida por Davyd Fontoura usando React e Tailwind CSS.",
      keywords:
        "klin ecommerce, sistema b2b, calçados infantis, desenvolvimento web, react, tailwind css, davyd fontoura, front-end developer, interface responsiva",
  ...
  },
  {
    ...
    slug: "capodarte-moda",
    description:
      "Atuei no desenvolvimento do sistema B2B da marca Capodarte, com foco em performance, usabilidade e fidelidade ao design da marca. O projeto foi realizado em parceria com a empresa TREIS – Soluções em Tecnologia.",
    ...
    seo: {
      title:
        "Sistema B2B Capodarte - Moda e Estilo - Davyd Fontoura | Portfolio",
      description:
        "Desenvolvimento de sistema B2B para a marca Capodarte, mantendo a elegância e sofisticação da marca. Projeto realizado por Davyd Fontoura com foco em performance e usabilidade.",
      keywords:
        "capodarte moda, sistema b2b, desenvolvimento web, interface elegante, tailwind css, davyd fontoura, front-end developer, design system",
  ...
  },
  {
    ...
    slug: "portal-de-noticias",
    description:
      "Site dinâmico de notícias desenvolvido com WordPress, oferecendo uma experiência de leitura envolvente e fácil navegação. O portal apresenta design responsivo, sistema de categorias, seção de comentários e otimização SEO.",
    shortDesc: "Portal de notícias focado nas noticías mais quentes do momento",
    fullDescription: `
        
        <p> O Fofoca Geral é um portal de notícias dinâmico e atualizado com as notícias mais quentes do momento. Densenvolvido com WordPress, o site oferece uma experiência de leitura envolvente e fácil de navegar para os usuários interessados em se manter informados sobre os acontecimentos atuais.</p>
            ...
            <ul style="list-style-type: disc; padding-left: 1.5em;">
                ...
                <li>Barra de pesquisa para encontrar notícias específicas</li>
                <li>Otimização SEO para melhor visibilidade nos motores de busca</li>
            </ul>
    ...
    features: [
      ...
      "Sistema de categorias para fácil navegação",
      "Seção de comentários para engajamento dos leitores",
      "Barra de pesquisa para encontrar notícias específicas",
    ...
    seo: {
      ...
      description:
        "Portal de notícias dinâmico desenvolvido com WordPress, oferecendo uma experiência de leitura envolvente e fácil navegação.",
      keywords:
        "portal de notícias, WordPress, notícias, SEO, design responsivo, Davyd Fontoura",
  ...
  },
  {
    ...
    description:
      "Aplicação web completa para gestão de confeitaria com cálculo automático de custos, precificação inteligente e controle de receitas. Sistema completo com autenticação, dashboard analítico e ferramentas de gestão financeira.",
    ...
    seo: {
      title:
        "WebApp Confeitaria - Sistema de Gestão - Davyd Fontoura | Portfolio",
      description:
        "Sistema completo de gestão para confeitarias com cálculo de custos, precificação inteligente e análise de lucratividade. Desenvolvido por Davyd Fontoura com React, TypeScript e Firebase.",
      keywords:
        "webapp confeitaria, gestão confeitaria, cálculo custos, react typescript, firebase, davyd fontoura, sistema gestão, precificação",
